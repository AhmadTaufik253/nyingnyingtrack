...
class FleetMapController extends Controller
{
    ...
    //     );
    // }
    public function deviceHistory(Request $req, $id)
    {
        $user = Auth::user();
        ...
        // default: hari ini
        $from = $validated['from'] ?? now()->startOfDay();
        ...
        $logs = $device->positions()
            ...
            ->map(function ($item) {
                ...
                return [
                    ...
                    'battery'    => isset($attr['67']) ? $attr['67'] / 1000 : null,
                    'voltage'    => isset($attr['66']) ? $attr['66'] / 1000 : null,
